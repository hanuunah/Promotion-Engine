...
{
    public class PromotionDataGenerator : IEnumerable<object[]>
    {
        ...
        public IEnumerator<object[]> GetEnumerator()
        {
            ...
            PrepareScenarioA(data, skuA, skuB, skuC);
            PrepareScenarioB(data, skuA, skuB, skuC);
            PrepareScenarioC(data, skuA, skuB, skuC);

            return data.GetEnumerator();
        }

        private static void PrepareScenarioC(List<object[]> data, Sku skuA, Sku skuB, Sku skuC)
        {
        ...
        private static void PrepareScenarioB(List<object[]> data, Sku skuA, Sku skuB, Sku skuC)
        {
        ...
        private static void PrepareScenarioA(List<object[]> data, Sku skuA, Sku skuB, Sku skuC)
        {
